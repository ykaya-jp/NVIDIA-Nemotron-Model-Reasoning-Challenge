...
| D | Equation/Symbol solver DSL + prototype | 🟡 走行中 (= 10 分経過時点で 未完了) | docs/research/2026-05-14-equation-dsl.md + src/.../solver_symbol.py |
...
3. 4-way ablation 並列 SFT (= A baseline / B answer-only / C solver-CoT v1 / D solver-CoT v1.5) を Colab Pro+ で kick off
...
- equation DSL (= worker D 走行中): docs/research/2026-05-14-equation-dsl.md (= 完了後追記予定)
